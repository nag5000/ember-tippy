...
a.EMBER_COMPONENT_IS_VISIBLE&&"style"===l&&void 0!==H&&(h=H(h,(0,o.childRefFor)(t,"isVisible"))),i.setAttribute(l,h,!1,null)}var H,q,W="display: none;",Y=U(W)
...
if(d&&d.length)(function(e,t,r,n){for(var i=[],s=e.length-1;-1!==s;){var l=z(e[s]),u=l[1];-1===i.indexOf(u)&&(i.push(u),$(t,r,l,n)),s--}if(-1===i.indexOf("id")){var c=t.elementId?t.elementId:(0,h.guidFor)(t)
...
r.setAttribute("id",(0,o.createPrimitiveRef)(m),!1,null),a.EMBER_COMPONENT_IS_VISIBLE&&q(c,r)}if(i){var v=Q(i)
...
return t?(0,o.valueForRef)(t):void 0}toString(){return`<${this.constructor.toString()}:${(0,h.guidFor)(this)}>`}}{constructor(){super(...arguments),this.listeners=new Map}static toString(){return"DeprecatedEventHandlersModifier"}install(){var{element:e,component:r,listenerFor:n,listeners:i}=this,a=[...De(Ge(this.owner)),...t]
...
return t=r.compute(i,a),(0,l.consumeTag)(r[vt]),t}getDebugName(e){return(0,h.getDebugName)(e.class.prototype)}}(0,d.setHelperManager)((e=>new yt(e)),gt)
...
class Ct{constructor(e,t){void 0===t&&(t=At),this.state=e,this.manager=t,this.handle=-1
var r=t.getCapabilities()
this.capabilities=(0,d.capabilityFlagsFrom)(r),this.compilable=r.wrapped?(0,m.unwrapTemplate)(e.template).asWrappedLayout():(0,m.unwrapTemplate)(e.template).asLayout(),this.resolvedName=e.name}}class xt extends me{constructor(e){super(),this.component=e}create(e,t,r,n,i){var{isInteractive:a}=n,s=this.component,o=(0,p._instrumentStart)("render.component",ve,s)
i.view=s
var u=""!==s.tagName
u||(a&&s.trigger("willRender"),s._transitionTo("hasElement"),a&&s.trigger("willInsertElement"))
var c=new X(s,null,l.CONSTANT_TAG,o,u,a)
return(0,l.consumeTag)(s[de]),c}}var St={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!1,createArgs:!1,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0,wrapped:!0,willDestroy:!1,hasSubOwner:!1}
class kt{constructor(e){this.handle=-1,this.resolvedName="-top-level",this.capabilities=(0,d.capabilityFlagsFrom)(St),this.compilable=null,this.manager=new xt(e),this.state=(0,R.getFactoryFor)(e)}}class Mt{constructor(e){this.inner=e}}var jt=J((e=>{var{positional:t}=e,r=t[0]
...
return this.position++,this.result=e.next(),{value:n,memo:i}}}class Ut extends Lt{valueFor(e){return e.value}memoFor(e,t){return t}}class Bt extends Lt{valueFor(e){return e.value[1]}memoFor(e){return e.value[0]}}function Vt(e){return"function"==typeof e.forEach}function zt(e){return"function"==typeof e[Symbol.iterator]}(0,A.default)({scheduleRevalidate(){f._backburner.ensureInstance()},toBool:function(e){return(0,h.isProxy)(e)?((0,l.consumeTag)((0,n.tagForProperty)(e,"content")),Boolean((0,n.get)(e,"isTruthy"))):(0,b.isArray)(e)?((0,l.consumeTag)((0,n.tagForProperty)(e,"[]")),0!==e.length):(0,P.isHTMLSafe)(e)?Boolean(e.toString()):Boolean(e)},toIterator:function(e){return e instanceof Mt?function(e){if(t=e,null===t||"object"!=typeof t&&"function"!=typeof t)return null
var t
...
class $t{constructor(e,t){this.owner=e,this.isInteractive=t,this.enableDebugTooling=E.ENV._DEBUG_RENDER_TREE}onTransactionCommit(){}}var Ht=J((e=>{var{positional:t,named:r}=e,n=t[0],i=r.type,a=r.loc,s=r.original;(0,o.valueForRef)(i),(0,o.valueForRef)(a),(0,o.valueForRef)(s)
...
s=(0,g.curry)(0,new Ct(l),null!==(r=null===(e=null==n?void 0:n.render)||void 0===e?void 0:e.owner)&&void 0!==r?r:t,h,!0)}else s=null
return s}))}))
...
var fr={action:te,mut:Qt,readonly:Xt,unbound:Jt,"query-params":Kt,"-hash":g.hash,"-each-in":jt,"-normalize-class":Wt,"-resolve":Yt,"-track-array":Gt,"-mount":dr,"-outlet":hr,"-in-el-null":qt}
...
return Nr(t)?null!==(e=t.values)&&void 0!==e?e:kr:t}var r=qr.call(this)
...
var Kr=Be(Ir,Cr),Xr=Et((function(e){return s.loc.apply(null,e)})),Jr=(0,r.templateFactory)({id:"3jT+eJpe",block:'[[[46,[28,[37,1],null,null],null,null,null]],[],false,["component","-outlet"]]',moduleName:"packages/@ember/-internals/glimmer/lib/templates/outlet.hbs",isStrictMode:!1}),Zr="-top-level",en="main"
...
Object.defineProperty(e,"__esModule",{value:!0}),e.TrackedDescriptor=e.SYNC_OBSERVERS=e.PROXY_CONTENT=e.PROPERTY_DID_CHANGE=e.NAMESPACES_BY_ID=e.NAMESPACES=e.Mixin=e.Libraries=e.DEBUG_INJECTION_FUNCTIONS=e.ComputedProperty=e.ASYNC_OBSERVERS=void 0,e._getPath=Re,e._getProp=Ee,e._setProp=Ae,e.activateObserver=P,e.addArrayObserver=function(e,t,r,n){void 0===n&&(n=!1)
...
return oe(new ke(t),Me)},e.beginPropertyChanges=B,e.changeProperties=z,e.computed=je,Object.defineProperty(e,"createCache",{enumerable:!0,get:function(){return o.createCache}}),e.defineProperty=ve,e.deprecateProperty=function(e,t,r,n){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set(e){Pe(this,r,e)},get(){return Oe(this,r)}})},e.descriptorForDecorator=ce,e.descriptorForProperty=ue,e.eachProxyArrayDidChange=function(e,t,r,n){var i=Le.get(e)
void 0!==i&&i.arrayDidChange(e,t,r,n)},e.eachProxyArrayWillChange=function(e,t,r,n){var i=Le.get(e)
void 0!==i&&i.arrayWillChange(e,t,r,n)},e.endPropertyChanges=V,e.expandProperties=fe,e.findNamespace=function(e){He||Xe()
...
if(k===r)return
k=r,O.forEach(((r,n)=>{var i=(0,t.peekMeta)(n)
...
Array.isArray(e)?G(e,t,r,n):e.replace(t,r,n)},e.replaceInNativeArray=G,e.sendEvent=b,e.set=Pe,e.setClassicDecorator=he,e.setNamespaceSearchDisabled=function(e){He=Boolean(e)},e.setProperties=function(e,t){if(null===t||"object"!=typeof t)return t
return z((()=>{for(var r,n=Object.keys(t),i=0;i<n.length;i++)r=n[i],Pe(e,r,t[r])})),t},e.tagForObject=function(e){if((0,r.isObject)(e))return(0,o.tagFor)(e,N)
return o.CONSTANT_TAG},e.tagForProperty=I,e.tracked=Ot,e.trySet=function(e,t,r){return Pe(e,t,r,!0)}
...
null!==o&&(o.isPrototypeMeta(e)||o.isInitializing())||x(e,s,a),g(e,s,n,i)}function T(e,t){var r=!0===t?w:O
...
var A=!1,C=[]
function x(e,t,r){if(void 0===r&&(r=!1),!0!==A){var n=!0===r?w:O,i=n.get(e)
...
null!==a&&(a.isInitializing()||a.isPrototypeMeta(e))||(D(e,r),L<=0&&M(),F in e&&(4===arguments.length?e[F](r,i):e[F](r)))}function B(){L++,A=!0}function V(){--L<=0&&(M(),function(){for(var[e,t,r]of(A=!1,C))x(e,t,r)
C=[]}())}function z(e){B()
try{e()}finally{V()}}function $(e,t,r,n){return void 0===t?(t=0,r=n=-1):(void 0===r&&(r=-1),void 0===n&&(n=-1)),b(e,"@array:before",[e,t,r,n]),e}function H(e,r,n,i,a){void 0===a&&(a=!0),void 0===r?(r=0,n=i=-1):(void 0===n&&(n=-1),void 0===i&&(i=-1))
...
l&&o.teardown(e,r,s),de(n)?ge(e,r,n,s):null==n?be(e,r,i,l,!0):Object.defineProperty(e,r,n),s.isPrototypeMeta(e)||S(e)}function ge(e,t,r,n){var i
...
return null!==a&&se.has(a.set)?(e[t]=n,n):(void 0!==(i=e[t])||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(e[t]=n,i!==n&&U(e,t)):e.setUnknownProperty(t,n),n)}function Ce(e,t,r,n){var i=t.split("."),a=i.pop(),s=Re(e,i)
...
var $e=Object.prototype.hasOwnProperty,He=!1,qe={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},We=!1,Ye=[]
e.NAMESPACES=Ye
...
for(var s in Ge[a]=t,(0,r.setName)(t,a),t)if($e.call(t,s)){var o=t[s]
...
f=m.desc,h=m.value}void 0!==h?("function"==typeof h&&ct(e,d,h,!0),be(e,d,h,-1!==u.indexOf(d),!i)):void 0!==f&&ge(e,d,f,o)}return o.isPrototypeMeta(e)||S(e),e}p.ALIAS_METHOD&&(et=function(e,t,r,n){var i,a=t.methodName,s=r[a],o=n[a]
...
return he(s),s}return Et(t)}function Et(e){var[n,i,a]=e,{getter:s,setter:l}=(0,o.trackedData)(i,a?a.initializer:void 0)
...
return se.add(c),(0,t.meta)(n).writeDescriptors(i,new Rt(u,c)),d}e.aliasMethod=ft,p.ALIAS_METHOD&&(e.aliasMethod=ft=function(e){return new ht(e)}),e.DEBUG_INJECTION_FUNCTIONS=mt
...
var v=O(this,t[h.STATE_SYMBOL]);(0,n.setProperties)(r,v)}this.setupController(r,e,t),this._environment.options.shouldRender&&this.renderTemplate(r,e),(0,n.flushAsyncObservers)(!1)}_qpChanged(e,t,r){if(r){var n=this._bucketCache,i=(0,p.calculateCacheKey)(r.route.fullRouteName,r.parts,r.values)
...
var h={qps:u,map:o}
return s&&(this._qpCache[r]=h),h}_fullyScopeQueryParams(e,t,r){for(var n,i=A(this,e,t).routeInfos,a=0,s=i.length;a<s;++a)if(n=this._getQPMeta(i[a]))for(var o=void 0,l=void 0,u=0,c=n.qps.length;u<c;++u)(l=(o=n.qps[u]).prop in r&&o.prop||o.scopedPropertyName in r&&o.scopedPropertyName||o.urlKey in r&&o.urlKey)&&l!==o.scopedPropertyName&&(r[o.scopedPropertyName]=r[l],delete r[l])}_hydrateUnsuppliedQueryParams(e,t,r){for(var n,i,a,s=e.routeInfos,o=this._bucketCache,l=0;l<s.length;++l)if(n=this._getQPMeta(s[l]))for(var u=0,c=n.qps.length;u<c;++u)if(i=n.qps[u],a=i.prop in t&&i.prop||i.scopedPropertyName in t&&i.scopedPropertyName||i.urlKey in t&&i.urlKey)a!==i.scopedPropertyName&&(t[i.scopedPropertyName]=t[a],delete t[a])
...
e.NativeArray=P
var A,C=["length"]
P.keys().forEach((e=>{Array.prototype[e]&&C.push(e)})),e.NativeArray=P=P.without(...C),e.A=A,s.ENV.EXTEND_PROTOTYPES.Array?(P.apply(Array.prototype,!0),e.A=A=function(e){return e||[]}):e.A=A=function(e){return e||(e=[]),R.detect(e)?e:P.apply(e)}
var x=R
...
return I(e,0)},e.intern=n,e.isEmberArray=function(e){return G.has(e)},e.isInternalSymbol=function(e){return-1!==h.indexOf(e)},e.isObject=i,e.isProxy=function(e){if(i(e))return H.has(e)
...
return V.call(t)},e.tryInvoke=function(e,t,r){if(L(e,t)){return e[t].apply(e,r)}},e.uuid=s,e.wrap=function(e,t){if(!O(e))return e
if(!P.has(t)&&O(t))return A(e,A(t,w))
return A(e,t)}
var a=0
...
var n=R.get(e)
return void 0!==n&&R.set(r,n),r}var{toString:C}=Object.prototype,{toString:x}=Function.prototype,{isArray:S}=Array,{keys:k}=Object,{stringify:M}=JSON,j=100,N=/^[\w$]+$/
...
Object.defineProperty(e,"__esModule",{value:!0}),e._backburner=void 0,e._cancelTimers=y,e._deprecatedGlobalGetCurrentRunLoop=void 0,e._getCurrentRunLoop=o,e._hasScheduledTimers=b,e._rsvpErrorQueue=e._queues=void 0,e.begin=m,e.bind=void 0,e.cancel=R,e.debounce=T,e.end=v,e.join=h,e.later=_,e.next=E,e.once=w,e.run=d,e.schedule=g,e.scheduleOnce=O,e.throttle=P
var s=null
...
return E(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:M("camelize",A)},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:M("decamelize",T)},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:M("dasherize",P)},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:M("underscore",x)},classify:{configurable:!0,enumerable:!1,writeable:!0,value:M("classify",C)},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:M("capitalize",S)}})}})),e("@ember/string/lib/string_registry",["exports"],(function(e){"use strict"
...
0
return N.set(t,e),t},e.setCustomTagFor=b,e.setHelperManager=function(e,t){return p(new j(e),t)},e.setInternalComponentManager=f,e.setInternalHelperManager=p,e.setInternalModifierManager=h,e.setModifierManager=function(e,t){return h(new x(e),t)}
...
return null!==r&&r<this.positional.length}}v=t.HAS_NATIVE_PROXY?(e,t)=>{var{named:r,positional:n}=e,i=new O(r),a=new E(n),s=Object.create(null),o=new Proxy(s,i),l=new Proxy([],a)
...
return m=c?{tag:g,element:r,delegate:u,args:p,modifier:l}:{tag:g,element:r,modifier:l,delegate:u,get args(){return S(o)}},(0,i.registerDestructor)(m,(()=>u.destroyModifier(l,h))),m}getDebugName(e){var{debugName:t}=e
...
return{named:a,positional:i.map(r.valueForRef)}}function k(e){return e.capabilities.hasValue}function M(e){return e.capabilities.hasDestroyable}e.CustomModifierManager=x
...
"number"==typeof n&&(n=(0,t.isSmallInt)(n)?(0,t.encodeImmediate)(n):{type:6,value:n}),e(30,n)}function S(e,t,n,i){e(0),R(e,n,i,!1),e(16,t),e(1),e(36,r.$v0)}function k(e,t,n,i){e(0),R(e,t,n,!1),e(33,r.$fp,1),e(107),i?(e(36,r.$v0),i(),e(1),e(34,1)):(e(1),e(34,1),e(36,r.$v0))}function M(e,t,r){R(e,r,null,!0),e(23,t),e(24),e(61),e(64),e(40),e(1)}function j(e,t){(function(e,t){null!==t?e(63,d({parameters:t})):x(e,null)})(e,t&&t[1]),e(62),D(e,t)}function N(e,t){e(0),D(e,t),e(61),e(2),e(1)}function I(e,t,n){var i=t[1],a=i.length,s=Math.min(n,a)
...
v(r)?e(1005,r,(t=>{S(e,t,n,i)})):(E(e,r),k(e,n,i))})),w.add(50,((e,t)=>{var[,n,i,a,s]=t;(function(e,t,n,i,a){e(0),R(e,i,a,!1),e(86),E(e,n),e(77,t,{type:2,value:void 0}),e(1),e(36,r.$v0)})(e,i,n,a,s)})),w.add(30,((e,t)=>{var[,r,n]=t
e(21,r),O(e,n)})),w.add(32,((e,t)=>{var[,r,n]=t
e(1011,r,(t=>{e(29,t),O(e,n)}))})),w.add(31,((e,t)=>{var[,r,n]=t
e(1009,r,(e=>{}))})),w.add(33,((e,t)=>{var[,r,n]=t
e(1010,r,((t,r)=>{e(21,0),e(22,t)})),O(e,n)})),w.add(34,(()=>{throw new Error("unimplemented opcode")})),w.add(36,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:t=>{S(e,t,null,null)},ifFallback:(t,r)=>{e(21,0),e(22,t)}})}))})),w.add(99,((e,t)=>{e(1010,t[1],(r=>{e(1006,t,{ifHelper:(r,n,i)=>{t[2][0]
S(e,r,null,null)},ifFallback:(t,r)=>{e(21,0),e(22,t)}})}))})),w.add(27,(e=>C(e,void 0))),w.add(48,((e,t)=>{var[,r]=t
...
if(null!==o){var b=p.indexOf(B);-1!==b&&(j(e,o),f.push(b))}for(var y=0;y<g.length;y++){var _=g[y],w=p.indexOf(`&${_}`);-1!==w&&(j(e,c.get(_)),f.push(w))}if((0,i.hasCapability)(a,8)){var O=T(e,l)<<4
O|=8
var R=t.EMPTY_STRING_ARRAY
if(null!==u){R=u[0]
for(var P=u[1],A=0;A<P.length;A++){var C=p.indexOf(R[A])
E(e,P[A]),m.push(C)}}e(82,R,t.EMPTY_STRING_ARRAY,O),m.push(-1)}else if(null!==u)for(var x=u[0],S=u[1],k=0;k<S.length;k++){var M=x[k],N=p.indexOf(M);-1!==N&&(E(e,S[k]),m.push(N),v.push(M))}e(97,r.$s0),(0,i.hasCapability)(a,64)&&e(59);(0,i.hasCapability)(a,512)&&e(87,0|c.has("default"),r.$s0)
...
m(n)?e(1003,n,(t=>{e(0),R(e,i,a,!1),e(57,t),e(1)})):(E(e,n),e(0),R(e,i,a,!1),e(33,r.$fp,1),e(108),e(1))})),Y.add(14,((e,t)=>{var[,r,n,i]=t
...
f(r)?e(1004,r,(t=>{V(e,t,n,null,i,a)})):z(e,r,n,null,i,a,!0,!0)})),Y.add(19,((e,t)=>{var[,n,i]=t
...
g(n)?e(1007,n,{ifComponent(t){V(e,t,null,i,J(a),null)},ifHelper(t){e(0),S(e,t,i,a),e(3,c("cautious-non-dynamic-append")),e(1)}}):F(e,(()=>{E(e,n),e(106)}),(t=>{t(0,(()=>{e(81),e(79),$(e,{capabilities:!0,elementBlock:null,positional:i,named:a,atNames:!1,blocks:l(null)})})),t(1,(()=>{k(e,i,a,(()=>{e(3,c("cautious-non-dynamic-append"))}))}))}))}else e(0),E(e,r),e(3,c("cautious-append")),e(1)
...
f(r)?e(1004,r,(t=>{V(e,t,null,n,J(i),a)})):z(e,r,null,n,i,a,!1,!1)})),Y.add(40,((e,t)=>{var[,n,i,a,s]=t
U(e,(()=>(E(e,i),void 0===s?C(e,void 0):E(e,s),E(e,a),e(33,r.$sp,0),4)),(()=>{e(50),N(e,n),e(56)}))})),Y.add(41,((e,t)=>{var[,r,n,i]=t
return U(e,(()=>(E(e,r),e(71),1)),(()=>{N(e,n)}),i?()=>{N(e,i)}:void 0)})),Y.add(42,((e,t)=>{var[,n,i,a,s]=t
return L(e,(()=>(i?E(e,i):C(e,null),E(e,n),2)),(()=>{e(72,u("BODY"),u("ELSE")),e(0),e(33,r.$fp,1),e(6,u("ITER")),e(1e3,"ITER"),e(74,u("BREAK")),e(1e3,"BODY"),I(e,a,2),e(34,2),e(4,u("FINALLY")),e(1e3,"BREAK"),e(1),e(73),e(4,u("FINALLY")),e(1e3,"ELSE"),s&&N(e,s)}))})),Y.add(43,((e,t)=>{var[,n,i,a]=t
...
f(r)?e(1004,r,(t=>{V(e,t,null,n,J(i),a)})):z(e,r,null,n,i,a,!1,!1)}))
...
o(t.value(h))}else if(31===u)s(y(i,e,r,t))
...
if((0,o.hasDestroyable)(c)){var p=c.getDestroyable(h);(0,i.associateDestroyableChild)(l,p)}return l},Object.defineProperty(e,"isDestroyed",{enumerable:!0,get:function(){return i.isDestroyed}}),Object.defineProperty(e,"isDestroying",{enumerable:!0,get:function(){return i.isDestroying}}),e.isSerializationFirstNode=function(e){return e.nodeValue===Kt},e.isWhitespace=function(e){return _t.test(e)},e.normalizeProperty=S,e.on=void 0,Object.defineProperty(e,"registerDestructor",{enumerable:!0,get:function(){return i.registerDestructor}}),e.rehydrationBuilder=function(e,t){return Jt.forInitialRender(e,t)},e.reifyArgs=Ne,e.reifyNamed=Me,e.reifyPositional=je,e.renderComponent=function(e,n,i,a,s,o,l){void 0===o&&(o={})
void 0===l&&(l=new d)
...
i=a}}function T(e){return P(e)?"":String(e)}function P(e){return null==e||"function"!=typeof e.toString}function A(e){return"object"==typeof e&&null!==e&&"function"==typeof e.toHTML}function C(e){return"object"==typeof e&&null!==e&&"number"==typeof e.nodeType}function x(e){return"string"==typeof e}function S(e,t){var r,n,i,a,s
...
for(var{positional:P,named:A}=R,C=P.length,x=0;x<C;x++)i.push(P[x])
for(var S=Object.keys(A),k=0;k<S.length;k++)i.push(A[S[k]])
l.setup(i,S,E,C,!1)}i.push(l)}else i.push(l)})),ce.add(87,((e,t)=>{var{op1:r,op2:n}=t,i=e.fetchValue(n),{definition:a,manager:s,capabilities:l}=i
...
if(-1!==O){var E=d[O-1],R=u.getSymbol(O)
_[E]=R}}if(y)for(var T=0;T<v.length;T++){var P=T+1,A=y[v[T]]
void 0!==A&&g.bind(P,A)}g.bindPartialMap(_),e.pushFrame(),e.call((0,t.unwrapHandle)(m))})),ce.add(72,((e,t)=>{var{op1:n,op2:i}=t,a=e.stack,s=a.pop(),o=a.pop(),l=(0,r.valueForRef)(o),u=null===l?"@identity":String(l),c=(0,r.createIteratorRef)(s,u),d=(0,r.valueForRef)(c)
...
var Pt,At=0
class Ct{constructor(e){this.id=At++,this.value=e}get(){return this.value}release(){this.value=null}toString(){var e=`Ref ${this.id}`
...
this.runtime=e,this.elementStack=n,this.context=i,this[St]=new qt,this[kt]=new t.Stack,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.v0=null,this.resume=Gt(this.context)
...
case a.$t1:this.t1=t
break
case a.$v0:this.v0=t}}pushFrame(){this[p].pushFrame()}popFrame(){this[p].popFrame()}goto(e){this[p].goto(e)}call(e){this[p].call(e)}returnTo(e){this[p].returnTo(e)}return(){this[p].return()}static initial(e,t,r){var{handle:n,self:i,dynamicScope:a,treeBuilder:s,numSymbols:o,owner:l}=r,u=h.root(i,o,l),c=Yt(e.program.heap.getaddr(n),u,a),d=Gt(t)(e,c,s)
return d.pushUpdating(),d}static empty(e,t,n){var{handle:i,treeBuilder:a,dynamicScope:s,owner:o}=t,l=Gt(n)(e,Yt(e.program.heap.getaddr(i),h.root(r.UNDEFINED_REFERENCE,0,o),s),a)
...
t.set(n,this.stack.pop())}}}function Yt(e,t,r){return{pc:e,scope:t,dynamicScope:r,stack:[]}}function Gt(e){return(t,r,n)=>new Wt(t,r,n,e)}e.LowLevelVM=Wt,St=m,kt=f
...
try{e[q]=t()}finally{r=B(),e[W]=r,e[Y]=f(r),$(r)}}return e[q]},e.isConst=function(e){G(e,"isConst")
var t=e[W]
...
e.combine=C
var x=w(),S=w(),k=w()
f(x),y(x),f(x),_(x,C([S,k])),f(x),y(S),f(x),y(k),f(x),_(x,k),f(x),y(k),f(x)
var M=new WeakMap
...
return F=L.pop()||null,d(e).combine()}function V(){L.push(F),F=null}function z(){F=L.pop()||null}function $(e){null!==F&&F.add(e)}var H=u("FN"),q=u("LAST_VALUE"),W=u("TAG"),Y=u("SNAPSHOT")
u("DEBUG_LABEL")
...
return 2===arguments.length?(t=arguments[0],i=arguments[1],e=null):([e,t,n]=g(...arguments),void 0===n?i=0:s(i=n.pop())||(r=!0===i,i=n.pop())),[e,t,n,i=parseInt(i,10),r]}var y=0,_=0,w=0,O=0,E=0,R=0,T=0,P=0,A=0,C=0,x=0,S=0,k=0,M=0,j=0,N=0,I=0,D=0,F=0,L=0,U=0
class B{constructor(e,t){this.DEBUG=!1,this.currentInstance=null,this.instanceStack=[],this._eventCallbacks={end:[],begin:[]},this._timerTimeoutId=null,this._timers=[],this._autorun=!1,this._autorunStack=null,this.queueNames=e,this.options=t||{},"string"==typeof this.options.defaultQueue?this._defaultQueue=this.options.defaultQueue:this._defaultQueue=this.queueNames[0],this._onBegin=this.options.onBegin||m,this._onEnd=this.options.onEnd||m,this._boundRunExpiredTimers=this._runExpiredTimers.bind(this),this._boundAutorunEnd=()=>{F++,!1!==this._autorun&&(this._autorun=!1,this._autorunStack=null,this._end(!0))}
var r=this.options._buildPlatform||i
this._platform=r(this._boundAutorunEnd)}get counters(){return{begin:_,end:w,events:{begin:O,end:0},autoruns:{created:D,completed:F},run:E,join:R,defer:T,schedule:P,scheduleIterable:A,deferOnce:C,scheduleOnce:x,setTimeout:S,later:k,throttle:M,debounce:j,cancelTimers:N,cancel:I,loops:{total:L,nested:U}}}get defaultQueue(){return this._defaultQueue}begin(){_++
...
return n.Adapter=i,n.QUnitAdapter=a,Object.defineProperty(B,"Test",{configurable:!0,writable:!0,enumerable:!0,value:n}),Object.defineProperty(B,"setupForTesting",{configurable:!0,writable:!0,enumerable:!0,value:s}),"Test"===e?n:s}}})}H("HTMLBars"),H("Handlebars"),q("Test"),q("setupForTesting"),(0,x.runLoadHooks)("Ember"),B.__loader={require:r.default,define:e,registry:void 0!==requirejs?requirejs.entries:r.default.entries}
var W=B
...
var E=new WeakMap
function R(e,r,n){return void 0===r&&(r={}),void 0===n&&(n=!1),e.map(((i,a)=>{var{name:s,params:o,paramNames:l,context:u,route:c}=i
...
return!Object.isExtensible(e)||e.hasOwnProperty("attributes")?Object.freeze((0,t.assign)({},e,n)):(0,t.assign)(e,n)}function P(e){return null!=e&&void 0!==e.buildRouteInfoMetadata?e.buildRouteInfoMetadata():null}class A{constructor(e,t,r,n){this._routePromise=void 0,this._route=null,this.params={},this.isResolved=!1,this.name=t,this.paramNames=r,this.router=e,n&&this._processRoute(n)}getModel(e){return r.Promise.resolve(this.context)}serialize(e){return this.params||{}}resolve(e){return r.Promise.resolve(this.routePromise).then((t=>(a(e),t))).then((()=>this.runBeforeModelHook(e))).then((()=>a(e))).then((()=>this.getModel(e))).then((t=>(a(e),t))).then((t=>this.runAfterModelHook(e,t))).then((t=>this.becomeResolved(e,t)))}becomeResolved(e,t){var r,n=this.serialize(t)
...
class C extends A{constructor(e,t,r,n,i,a){super(e,t,r,i),this.params=n,this.isResolved=!0,this.context=a}resolve(e){return e&&e.resolvedModels&&(e.resolvedModels[this.name]=this.context),r.Promise.resolve(this)}}class x extends A{constructor(e,t,r,n,i){super(e,t,r,i),this.params={},this.params=n}getModel(e){var t=this.params
e&&e[y]&&(l(t={},this.params),t.queryParams=e[y])
var n,i=this.route
return i.deserialize?n=i.deserialize(t,e):i.model&&(n=i.model(t,e)),n&&O(n)&&(n=void 0),r.Promise.resolve(n)}}class S extends A{constructor(e,t,r,n){super(e,t,r),this.context=n,this.serializer=this.router.getSerializer(t)}getModel(e){return void 0!==this.router.log&&this.router.log(this.name+": resolving provided model"),super.getModel(e)}serialize(e){var{paramNames:t,context:r}=this
e||(e=r)
var n={}
...
const l=(0,r.createTemplateFactory)({id:"GV3uiy+O",block:'[[[11,0],[24,"hidden",""],[4,[30,0,["tippyModifier"]],[[30,0,["options"]]],null],[12],[18,1,[[30,0,["yieldTippyInstance"]],[30,0,["options"]]]],[13]],["&default"],false,["yield"]]',moduleName:"ember-tippy/components/tippy.hbs",isStrictMode:!1})
...
e?.(this._instancesArray,{singleton:this._singleton}),this._singleton?.destroy(),this._instancesArray.forEach((e=>e.destroy())),this._singleton=null,this._instances=null,this._options=null}}e.default=i}))
